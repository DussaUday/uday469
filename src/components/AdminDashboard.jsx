...
function AdminDashboard({ setIsAuthenticated }) {
  ...
  const fetchProjects = async () => {
    try {
      const res = await axios.get('https://portfolio-server-9qz2.onrender.com/projects');
  ...
  const fetchCertificates = async () => {
    try {
      const res = await axios.get('https://portfolio-server-9qz2.onrender.com/certificates');
  ...
  const fetchSkills = async () => {
    try {
      const res = await axios.get('https://portfolio-server-9qz2.onrender.com/skills');
      setSkills(res.data);
    } catch (error) {
  ...
  const fetchResume = async () => {
    try {
      const res = await axios.get('https://portfolio-server-9qz2.onrender.com/resumes');
      setResume(res.data);
    } catch (error) {
  ...
  const handleProjectSubmit = async (e) => {
    ...
    try {
      ...
      if (editing) {
        await axios.put(`https://portfolio-server-9qz2.onrender.com/projects/${editing}`, data, config);
      } else {
        await axios.post('https://portfolio-server-9qz2.onrender.com/projects', data, config);
      }
      fetchProjects();
      resetForm();
    } catch (err) {
  ...
  const handleCertificateSubmit = async (e) => {
    ...
    try {
      ...
      if (editing) {
        await axios.put(`https://portfolio-server-9qz2.onrender.com/certificates/${editing}`, data, config);
      } else {
        await axios.post('https://portfolio-server-9qz2.onrender.com/certificates', data, config);
      }
      fetchCertificates();
      resetForm();
    } catch (err) {
  ...
  const handleSkillSubmit = async (e) => {
    ...
    try {
      ...
      if (editing) {
        await axios.put(`https://portfolio-server-9qz2.onrender.com/skills/${editing}`, skillData, config);
      } else {
        await axios.post('https://portfolio-server-9qz2.onrender.com/skills', skillData, config);
      }
      fetchSkills();
      resetForm();
    } catch (err) {
  ...
  const handleResumeSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('https://portfolio-server-9qz2.onrender.com/resumes', data, config);
      fetchResume();
      resetForm();
    } catch (err) {
  ...
  const handleDelete = async (type, id) => {
    try {
      ...
      await axios.delete(`https://portfolio-server-9qz2.onrender.com/${type}/${id}`, config);
